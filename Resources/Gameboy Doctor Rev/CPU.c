...
uint8_t CPUExecuteInstruction(CPU *CPU, MMU *MMU) {
    ...
    switch (opcode) {
        ...
        case (0x1F): { //RRA
            n8 = CPU->RegF & 0x10;
            CPU->RegF = (CPU->RegA & 0x01) << 4; //Set Carry Flag
